...
public class Assignment002Demo {
	...
	public void assignment002Post() {
		...
		File file = new File("C:\\java\\Phase-3RestAssured\\src\\main\\java\\courseEndProject\\data.json");
	...
	public void assignment002Put() {
		File file = new File("C:\\java\\Phase-3RestAssured\\src\\main\\java\\courseEndProject\\data1.json");
